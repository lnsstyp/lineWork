        ...
        $(mainImage).load(function(e){
            ...
            for (var row = 0; row < breakCount; row++) {
                for (var col = 0; col < breakCount; col++) {
                    ...
                    gameContext.drawImage(this, col * aw, row * ah, aw, ah, 0, 0, bw + 1, bh + 1);
            ...
            cursor1.css('border-top', '2px solid #fff');
            cursor1.css('border-left', '2px solid #fff');
            cursor1.css('border-right', '2px solid #fff');
            cursor1.css('border-bottom', '2px solid #fff');
