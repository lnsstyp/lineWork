...
Paging.prototype = {
    ...
    this.container.on('click', 'li.js-page-action,li.ui-pager', function(e) {
      ...
      if ($(this).hasClass('js-page-action')) {
        if ($(this).hasClass('js-page-first')) {
          _this.current = 1;
          $("tr:not(:first-child)", $("#orderdetail")).each(function(index, el) {
            $(this).css('display', 'table-row');
            if (index > _this.pagesize - 1) {
        ...
        if ($(this).hasClass('js-page-prev')) {
          ...
          $("tr:not(:first-child)", $("#orderdetail")).each(function(index, el) {
            $(this).css('display', 'table-row');
            if ((index < _this.pagesize * (_this.current - 1)) || (index > _this.pagesize * _this.current - 1)) {
              $(this).css('display', 'none');
            };
          });
        }
        ...
        if ($(this).hasClass('js-page-last')) {
          ...
          $("tr:not(:first-child)", $("#orderdetail")).each(function(index, el) {
            $(this).css('display', 'table-row');
            if (index < _this.pagesize * (_this.pagecount - 1)) {
              $(this).css('display', 'none');
            };
          });
        }
  ...
  bindToolbar: function() {
    ...
    sel.change(function() {
      _this.changePagesize($(this).val(), $("tr:not(:first-child)", $("#orderdetail")).length);
      var current = parseInt($(this).next().val()) || 1;
      _this.go(current)
      $("tr:not(:first-child)", $("#orderdetail")).each(function(index, el) {
        $(this).css('display', 'table-row');
        if ((index < _this.pagesize * (_this.current - 1)) || (index > _this.pagesize * _this.current - 1)) {
